...
void Photino::GetCurrentMonitor(Monitor &monitor)
{
    ...
    if (GetMonitorInfo(hMonitor, &monitorInfo)) {
        /*monitor.monitor.x = monitorInfo.rcMonitor.left;
        monitor.monitor.y = monitorInfo.rcMonitor.top;
        monitor.monitor.width = monitorInfo.rcMonitor.right - monitorInfo.rcMonitor.left;
        monitor.monitor.height = monitorInfo.rcMonitor.bottom - monitorInfo.rcMonitor.top;
        monitor.work.x = monitorInfo.rcWork.left;
        monitor.work.y = monitorInfo.rcWork.top;
        monitor.work.width = monitorInfo.rcWork.right - monitorInfo.rcWork.left;
        monitor.work.height = monitorInfo.rcWork.bottom - monitorInfo.rcWork.top;*/
